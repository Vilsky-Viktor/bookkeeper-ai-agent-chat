...
function AppContent({ user }: { user: User | null }) {
  ...
  return (
    <div className="flex h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="flex w-[480px] min-w-[320px] flex-col border-r border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <header className="relative z-10 flex items-center justify-between border-b border-zinc-200 px-4 py-2.5 shadow-[0_4px_6px_-1px_rgb(0_0_0_/_0.05),0_2px_4px_-2px_rgb(0_0_0_/_0.05)] dark:border-zinc-800">
